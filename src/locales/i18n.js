    ...
    en: {
      translation: {
        ...
        webDevelopmentDesc: {
          ...
          span5: "TailwindCSS",
          rest:
            ". My goal is to ensure that your site is not only visually pleasing, but also intuitive for users."
        },
        ...
        backendDesc: {
          ...
          text2: 'I apply the',
          span2: 'MVC',
          text3: 'pattern to structure projects in an organized and maintainable way.',
        },
        ...
        dbDesc: {
          ...
          text2: 'and ',
          text3: 'PostgreSQL ',
          text4: 'to manage and store data effectively, ensuring optimal performance.',
        },
    ...
    es: {
      translation: {
        ...
        webDevelopmentDesc: {
          ...
          span5: "TailwindCSS",
          rest:
            ". Mi objetivo es asegurarme de que tu sitio no solo sea visualmente atractivo, sino también intuitivo para los usuarios."
        },
        ...
        backendDesc: {
          ...
          text1: 'Implemento soluciones backend sólidas utilizando lenguajes como',
        ...
        dbDesc: {
          ...
          text2: 'y ',
          text3: 'PostgreSQL ',
          text4: 'para gestionar y almacenar datos de manera efectiva, asegurando un rendimiento óptimo.',
        },
