          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mx-4 mb-12 lg:mx-20'>
            <div>
              <div className='flex flex-col justify-center items-center shadow-lg p-10 rounded-xl my-10 bg-teal-500 dark:bg-teal-500 lg:flex lg:flex-col '>
                ...
                <a  href="mailto:karlentkzar@gmail.com?subject=Consulta&body=Hola, quiero más información"  className='pt-1 text-gray-100  hover:text-gray-600'>karlentkzar@gmail.com</a>
                <p className='pt-1 text-teal-300'>
              ...
              <div className='flex flex-col justify-center items-center shadow-lg p-10 rounded-xl my-10 bg-teal-500 dark:bg-teal-500 lg:flex lg:flex-col '>
                ...
                <a
                  href='https://wa.me/632582005'
                  target='_blank'
                  className='pt-1 text-gray-100 hover:text-gray-600'
                >
                  +34 632582005
                </a>
                <p className='pt-1 text-teal-300'>
            ...
            <Container className='flex flex-col items-center mx-4 p-8 lg:mx-20'>
              ...
              <FormControl
                ...
                mb={5}
              >
                <FormErrorMessage>{t('contactForm.required')}</FormErrorMessage>
                <Input
              ...
              <Button
                className='cursor-big bg-teal-500 text-white p-2 rounded-md hover:bg-gray-600'
                type='submit'
                isLoading={isLoading}
                disabled={
                  !values.name ||
